    ...
    <div className="flex md:flex-row flex-col w-[100%]">
      <div className="flex flex-col px-2 w-[65%]">
        ...
        <div className="pt-5 px-2">
          <div className="w-fit">
            <h1 className="text-white text-lg font-bold">{youtubeVideoTitle}</h1>
          </div>
            <div className="flex items-center gap-14 md:gap-9 py-5">
                <div className="flex items-center gap-1">
                   ...
                   <h1 className="text-white px-1 font-bold w-fit text-md">{youtubeVideoChannelTitle}</h1>
                </div>
                <div className="flex">
                  <button className="border hidden md:block text-sm font-bold px-4 py-2 rounded-full mx-3">Join</button>
                  <button className="flex px-4 text-sm font-bold py-1 md:py-2 rounded-full border"><span>🔔</span>Subscribed</button>
                </div>
